...
DEPS="pytest pytest-django pytest-cov pytest-splinter"
...
DJANGO_SETTINGS_MODULE=test_project.settings py.test -vv --cov django_addanother --create-db --strict -r fEsxXw test_project/testapp/tests.py
