...
if [ $PYTHON_VERSION = 2.7 ]; then
  ...
  DEPS="$DEPS django-appconf pytest-splinter splinter<0.18"  # TODO: Remove splinter pin https://github.com/pytest-dev/pytest-splinter/commit/0f9cae60055399bff9e3f3ce2c039d9c38f28e21
fi
